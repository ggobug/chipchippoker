...
VALUES (b'0', b'0', NOW(), NULL, NULL, NULL, NOW(), CONVERT(FLOOR(RAND() * 20) + 1, CHAR), 'kwon1234', '권순준닉네임',
        SHA2('password123!', 256), NULL),
       (b'0', b'0', NOW(), NULL, NULL, NULL, NOW(), CONVERT(FLOOR(RAND() * 20) + 1, CHAR), 'lim1234', '임세환닉네임',
        SHA2('password123!', 256), NULL),
       (b'0', b'0', NOW(), NULL, NULL, NULL, NOW(), CONVERT(FLOOR(RAND() * 20) + 1, CHAR), 'yoon1234', '윤예빈닉네임',
        SHA2('password123!', 256), NULL),
       (b'0', b'0', NOW(), NULL, NULL, NULL, NOW(), CONVERT(FLOOR(RAND() * 20) + 1, CHAR), 'choi1234', '최현기닉네임',
        SHA2('password123!', 256), NULL),
       (b'0', b'0', NOW(), NULL, NULL, NULL, NOW(), CONVERT(FLOOR(RAND() * 20) + 1, CHAR), 'sun1234', '선수연닉네임',
        SHA2('password123!', 256), NULL),
       (b'0', b'0', NOW(), NULL, NULL, NULL, NOW(), CONVERT(FLOOR(RAND() * 20) + 1, CHAR), 'kim1234', '김대원닉네임',
        SHA2('password123!', 256), NULL),
...
-- point
INSERT INTO point (competitive_draw, competitive_lose, competitive_win, current_winning_streak, friendly_draw,
                   friendly_lose, friendly_win, max_win,
                   point_score, created_at,
                   member_id, updated_at)
VALUES (4, 5, 12, 8, 7, 11, 20, 8, 976, NOW(), 1, NOW()),
       (3, 4, 8, 5, 4, 8, 26, 6, 1010, NOW(), 2, NOW()),
       (5, 3, 15, 5, 3, 1, 32, 7, 980, NOW(), 3, NOW()),
       (7, 0, 8, 6, 2, 21, 40, 6, 965, NOW(), 4, NOW()),
       (8, 1, 20, 5, 1, 10, 50, 12, 1005, NOW(), 5, NOW()),
       (10, 6, 11, 5, 0, 10, 10, 10, 899, NOW(), 6, NOW()),
       (5, 2, 9, 5, 0, 11, 8, 5, 932, NOW(), 7, NOW()),
       (5, 2, 8, 5, 0, 11, 8, 6, 800, NOW(), 8, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 932, NOW(), 9, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 888, NOW(), 10, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 932, NOW(), 11, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 760, NOW(), 12, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 932, NOW(), 13, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 760, NOW(), 14, NOW()),
       (5, 2, 8, 5, 7, 11, 8, 6, 760, NOW(), 15, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 760, NOW(), 16, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 760, NOW(), 17, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 760, NOW(), 18, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 760, NOW(), 19, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 760, NOW(), 20, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 760, NOW(), 21, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 22, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1000, NOW(), 23, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1000, NOW(), 24, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 25, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1000, NOW(), 26, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 27, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1000, NOW(), 28, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1000, NOW(), 29, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 30, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 1000, NOW(), 31, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 32, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 33, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 34, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 35, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 36, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 37, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 38, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 39, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 800, NOW(), 40, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 41, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 987, NOW(), 42, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 920, NOW(), 43, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 888, NOW(), 44, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 45, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 987, NOW(), 46, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 699, NOW(), 47, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 870, NOW(), 48, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 700, NOW(), 49, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 950, NOW(), 50, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 987, NOW(), 51, NOW()),
       (5, 2, 8, 5, 7, 11, 20, 6, 988, NOW(), 52, NOW());
