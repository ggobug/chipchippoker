  ...
  <div class="container mainstyle d-flex flex-row profile-box-radius" >
    ...
    <div class="d-flex flex-column w-100">
      ...
      <div v-if="userStore?.profileInfo?.isMine" class="d-flex flex-row-reverse" style="margin-right: 16px;">
        ...
        <button v-if="!(userStore.kakaoAccessToken !== null || userStore.profileInfo.isKakaoConnect === true || userStore.isKakaoConnect === true)" @click="kakaoConnect()" class="btn-2 btn-2-yellow">
